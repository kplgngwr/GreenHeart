  ...
  return (
    <header className="flex justify-between items-center bg-gray-100 border-b border-gray-300 h-16 px-5 md:px-10">
      ...
      <div className="flex items-center space-x-6">
        ...
        <a href='/signup' className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Sign Up</a>
        <a href='/signin' className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">Login</a>
      </div>
    </header>
  );
}
